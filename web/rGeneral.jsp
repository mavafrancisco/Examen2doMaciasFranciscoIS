<%-- 
    Document   : rGeneral
    Created on : 22/10/2025, 12:24:49 PM
    Author     : frank
--%>

<html>
    <head>
        <title>Pagina  Macias Aplicacion WEB </title>
        <meta charset="UTF-8">
              ...
              <div class="row"><!--Inicia fila-->
                  <form method="post" action="rAlumno1.jsp">
                      <div class="row">
                          ...
                          <div class="col-sm-6">
                              <label>Nombre</label>
                              <input class="input" type="text" placeholder="Nombre" required name="usuario"/>
                              <label>Precio</label>
                              <input class="input" type="text" placeholder="Precio" required name="contrase"/>
                              <label>Cantidad</label>
                              <input class="input" type="text" placeholder="Cantidad" required name="cantidad"/>
                              <br><br><!-- 2 saltos de linea -->
                              <input type="submit" class="primary-btn order-submit" value="Registrar Producto"/>
                          </div>
                         </center>  
                      </div>
