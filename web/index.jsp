<%-- 
    Document   : index
    Created on : 22/10/2025, 12:09:21 PM
    Author     : frank
--%>
                ...
                <table class="table table-striped table-bordered table-hover" style="text-align: center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-info" href="editarAlumno.jsp?id_usuario=<%= rs.getString(1)%>&usuario=<%= rs.getString(2)%>&password=<%= rs.getString(3)%>&cantidad=<%= rs.getString(4)%>">Editar</a></td>
                        </tr>
                        <%
                          }//termina while  
                        %>
